...
class TableFormattingTest < Minitest::Test
  ...
  def test_format_decimal_less_than_one
    assert_equal '0.2', Spout::Helpers::TableFormatting.format_number(0.19, :decimal)
    assert_equal '0.04', Spout::Helpers::TableFormatting.format_number(0.044, :decimal)
    assert_equal '-0.004', Spout::Helpers::TableFormatting.format_number(-0.0036, :decimal)
  end
end
